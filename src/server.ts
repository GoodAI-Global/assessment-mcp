...
import {
  assessAIReadiness,
  AssessAIReadinessInputSchema,
  ASSESS_AI_READINESS_TOOL,
} from "./tools/assess_ai_readiness.js";
import {
  identifyBottlenecks,
  IdentifyBottlenecksInputSchema,
  IDENTIFY_BOTTLENECKS_TOOL,
} from "./tools/identify_bottlenecks.js";
import {
  generatePilotPlan,
  GeneratePilotPlanInputSchema,
  GENERATE_PILOT_PLAN_TOOL,
} from "./tools/generate_pilot_plan.js";
import {
  calculateROI,
