...
export const GENERATE_SOW_TOOL = {
    name: "generate_sow",
    description: "Generates a professional Statement of Work (SOW) document for AI consulting engagements. Includes scope, deliverables, timeline, pricing, team composition, assumptions, and standard terms.",
    inputSchema: {
        type: "object",
        properties: {
...
function generatePhases(engagementType, durationWeeks, deliverables) {
...
function generateDefaultMilestones(engagementType, durationWeeks) {
    const templates = {
        assessment: [
...
function generateDefaultTeam(engagementType) {
    const templates = {
        assessment: [
            {
...
function generateDefaultClientResponsibilities(engagementType) {
    const base = [
...
function generateDefaultAssumptions(engagementType, industry) {
    const base = [
...
function getPricingModelDescription(model) {
    const descriptions = {
...
function generatePaymentSchedule(totalValue, milestones) {
    return milestones
...
/** Generate risk items */
function generateRisks(engagementType) {
    const common = [
        {
...
export function generateSOW(input) {
    const { client_name, engagement_title, engagement_type, industry, objectives, deliverables, out_of_scope, start_date, duration_weeks, total_value_usd, pricing_model, payment_terms, team_composition, client_responsibilities, assumptions, dependencies, change_control_process, consultant_name, consultant_company, } = input;
    ...
    return {
        ...
        change_management: {
            process: change_control_process ||
...
//# sourceMappingURL=generate_sow.js.map