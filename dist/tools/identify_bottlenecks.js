...
// ============================================
function analyzeBottlenecks(input) {
    const bottlenecks = [];
...
function identifyQuickWins(bottlenecks) {
    return bottlenecks
...
export function identifyBottlenecks(input) {
    ...
    const highestImpact = bottlenecks.length > 0
...
export const IDENTIFY_BOTTLENECKS_TOOL = {
    ...
    description: "Analyze processes to identify operational bottlenecks with cost estimation and AI solution fit scores. Ranks opportunities by impact and implementation complexity.",
    inputSchema: {
        type: "object",
        properties: {
            process_description: {
...
//# sourceMappingURL=identify_bottlenecks.js.map